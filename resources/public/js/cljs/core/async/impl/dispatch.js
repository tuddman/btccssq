...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_11437 = 0;while(true){
var m_11438 = cljs.core.async.impl.dispatch.tasks.pop();if((m_11438 == null))
{} else
{m_11438.call(null);
if((count_11437 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__11439 = (count_11437 + 1);
count_11437 = G__11439;
continue;
}
} else
{}
