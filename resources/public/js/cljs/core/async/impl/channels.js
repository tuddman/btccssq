...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t11443 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t11443 = (function (val,box,meta11444){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t11443.cljs$lang$type = true;
cljs.core.async.impl.channels.t11443.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t11443";
cljs.core.async.impl.channels.t11443.cljs$lang$ctorPrWriter = (function (this__3971__auto__,writer__3972__auto__,opt__3973__auto__){return cljs.core._write.call(null,writer__3972__auto__,"cljs.core.async.impl.channels/t11443");
});
cljs.core.async.impl.channels.t11443.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t11443.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11445){var self__ = this;
var _11445__$1 = this;return self__.meta11444;
});
cljs.core.async.impl.channels.t11443.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11445,meta11444__$1){var self__ = this;
var _11445__$1 = this;return (new cljs.core.async.impl.channels.t11443(self__.val,self__.box,meta11444__$1));
});
cljs.core.async.impl.channels.__GT_t11443 = (function __GT_t11443(val__$1,box__$1,meta11444){return (new cljs.core.async.impl.channels.t11443(val__$1,box__$1,meta11444));
});
}
return (new cljs.core.async.impl.channels.t11443(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3974__auto__,writer__3975__auto__,opts__3976__auto__){return cljs.core._write.call(null,writer__3975__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3971__auto__,writer__3972__auto__,opt__3973__auto__){return cljs.core._write.call(null,writer__3972__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_11446 = self__.takes.pop();if((taker_11446 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_11446))
{var take_cb_11447 = cljs.core.async.impl.protocols.commit.call(null,taker_11446);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_11447,taker_11446){
return (function (){return take_cb_11447.call(null,null);
});})(take_cb_11447,taker_11446))
);
} else
{}
{
