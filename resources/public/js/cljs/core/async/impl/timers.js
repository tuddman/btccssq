...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3971__auto__,writer__3972__auto__,opt__3973__auto__){return cljs.core._write.call(null,writer__3972__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_11402 = 0;while(true){
if((i_11402 < arr.length))
{(arr[i_11402] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3971__auto__,writer__3972__auto__,opt__3973__auto__){return cljs.core._write.call(null,writer__3972__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_11409 = (self__.level + 1);while(true){
if((i_11409 <= (new_level + 1)))
{(update[i_11409] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_11411 = 0;while(true){
if((i_11411 <= self__.level))
{var links_11412 = (update[i_11411]).forward;if(((links_11412[i_11411]) === x__$1))
{(links_11412[i_11411] = (x__$1.forward[i_11411]));
{
