...
{var pred__7352 = cljs.core._EQ_;var expr__7353 = limit;if(cljs.core.truth_(pred__7352.call(null,1,expr__7353)))
...
var G__7355 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__7356 = (limit__$1 - 1);
var G__7357 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__7355;
limit__$1 = G__7356;
parts = G__7357;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___7359 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___7359))
{var replacement_7360 = temp__4090__auto___7359;buffer.append([cljs.core.str(replacement_7360)].join(''));
} else
{buffer.append(ch);
}
{
