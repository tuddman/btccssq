...
{{
var G__8724 = cljs.core.pop.call(null,v__$1);
v__$1 = G__8724;
continue;
}
} else
...
{var pred__8728 = cljs.core._EQ_;var expr__8729 = limit;if(cljs.core.truth_(pred__8728.call(null,1,expr__8729)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__8728.call(null,2,expr__8729)))
...
var G__8731 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__8732 = (limit__$1 - 1);
var G__8733 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__8731;
limit__$1 = G__8732;
parts = G__8733;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___8735 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___8735))
{var replacement_8736 = temp__4090__auto___8735;buffer.append([cljs.core.str(replacement_8736)].join(''));
} else
{buffer.append(ch);
}
{
