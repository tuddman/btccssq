...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__3971__auto__,writer__3972__auto__,opt__3973__auto__){return cljs.core._write(writer__3972__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13144 = 0;while(true){
if((i_13144 < arr.length))
{(arr[i_13144] = null);
{
var G__13145 = (i_13144 + 1);
i_13144 = G__13145;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__3971__auto__,writer__3972__auto__,opt__3973__auto__){return cljs.core._write(writer__3972__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_13151 = (self__.level + 1);while(true){
if((i_13151 <= (new_level + 1)))
{(update[i_13151] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13153 = 0;while(true){
if((i_13153 <= self__.level))
{var links_13154 = (update[i_13153]).forward;if(((links_13154[i_13153]) === x__$1))
{(links_13154[i_13153] = (x__$1.forward[i_13153]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3409__auto__ = (cljs.core.truth_((function (){var and__3397__auto__ = me;if(cljs.core.truth_(and__3397__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3397__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3409__auto__))
