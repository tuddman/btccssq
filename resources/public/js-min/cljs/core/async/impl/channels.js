...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13185 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13185 = (function (val,box,meta13186){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13185.cljs$lang$type = true;
cljs.core.async.impl.channels.t13185.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13185";
cljs.core.async.impl.channels.t13185.cljs$lang$ctorPrWriter = (function (this__3971__auto__,writer__3972__auto__,opt__3973__auto__){return cljs.core._write(writer__3972__auto__,"cljs.core.async.impl.channels/t13185");
});
cljs.core.async.impl.channels.t13185.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13185.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13187){var self__ = this;
var _13187__$1 = this;return self__.meta13186;
});
cljs.core.async.impl.channels.t13185.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13187,meta13186__$1){var self__ = this;
var _13187__$1 = this;return (new cljs.core.async.impl.channels.t13185(self__.val,self__.box,meta13186__$1));
});
cljs.core.async.impl.channels.__GT_t13185 = (function __GT_t13185(val__$1,box__$1,meta13186){return (new cljs.core.async.impl.channels.t13185(val__$1,box__$1,meta13186));
});
}
return (new cljs.core.async.impl.channels.t13185(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3974__auto__,writer__3975__auto__,opts__3976__auto__){return cljs.core._write(writer__3975__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3971__auto__,writer__3972__auto__,opt__3973__auto__){return cljs.core._write(writer__3972__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13188 = self__.takes.pop();if((taker_13188 == null))
{} else
{if(taker_13188.cljs$core$async$impl$protocols$Handler$active_QMARK_$arity$1(null))
{var take_cb_13189 = taker_13188.cljs$core$async$impl$protocols$Handler$commit$arity$1(null);cljs.core.async.impl.dispatch.run(((function (take_cb_13189,taker_13188){
return (function (){return (take_cb_13189.cljs$core$IFn$_invoke$arity$1 ? take_cb_13189.cljs$core$IFn$_invoke$arity$1(null) : take_cb_13189.call(null,null));
});})(take_cb_13189,taker_13188))
);
} else
{}
{
